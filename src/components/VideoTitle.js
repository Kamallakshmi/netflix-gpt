...
const VideoTitle = ({ title, overview }) => {
  return (
    <div className="w- screen h-screen aspect-video absolute  bg-gradient-to-r from-black via-transparent to-transparent text-white px-8 md:px-12 pt-[25%] md:pt-[15%]">
